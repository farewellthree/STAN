...
from mmcv.runner.dist_utils import allreduce_grads as _allreduce_grads
...
def patch_norm_fp32(module):
    ...
    Returns:
        nn.Module: The converted module, the normalization layers have been
            converted to FP32.
    """
    if isinstance(module, (nn.modules.batchnorm._BatchNorm, nn.GroupNorm, nn.LayerNorm)):
        module.float()
        if isinstance(module, (nn.GroupNorm, nn.LayerNorm)) or torch.__version__ < '1.3':
