...
model = dict(
    ...
    visual_encoder=dict(type='VITCLIPPretrained_STAN', depth=4, pretrained_model=pretrained_model, gradient_checkpointing=True, patch_3d=False,
        all_patch=True),
...
dataset_type = 'DidemoDataset'
data_root = '/Path/to/your/didemo/dataset'
...
default_hooks = dict(checkpoint=dict(type='printBest_CheckpointHook', interval=-1, save_best='retrieval/R1', rule='greater'))
