...
def parse_sthv2_splits(level):
    ...
    # Read the annotations
    # yapf: disable
    class_index_file = 'data/sthv2/annotations/labels.json'  # noqa
    # yapf: enable
    train_file = 'data/sthv2/annotations/train.json'
    val_file = 'data/sthv2/annotations/validation.json'
    test_file = 'data/sthv2/annotations/test.json'
