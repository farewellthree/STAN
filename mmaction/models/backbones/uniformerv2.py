...
class Extractor(BaseModule):
    ...
    #看不懂了，后面可以跑一下他在干什么，为什么不直接输入self.attn里
        ...
        for i, resblock in enumerate(self.resblocks):
            ...
            if i in self.return_list:
                ...
                if self.dpe:
                    ...
                    tmp_x[1:] = tmp_x[1:] + tmp_feats  #直接residual，维度没降的吗？？？？
                # global block
...
class UniFormerV2(BaseModule):
    ...
    def _load_pretrained(self, pretrained: str = None) -> None:
        ...
        model_path = 'ckpt/uniformerv2/vit-base-p16-res224_clip-rgb_20221219-b8a5da86.pth'
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        N, C, T, H, W = x.shape
        x = x.permute(0, 2, 3, 4, 1).contiguous().reshape(N * T, H * W, C)
